          ...
          <div className='w-full flex flex-col items-center'>
              ...
              <MdOutlineArrowLeft className='text-white w-[1.5rem] h-[1.5rem] transition-all duration-300' style={{rotate:pRotate?'-90deg':'0deg'}}/>
                ...
                <div className='flex flex-col text-white gap-3 text-sm bg-[#313e4d] justify-center items-center rounded-sm w-[50%] cursor-default transition-all ease-in-out duration-400' style={{height:nRotate?'fit-content':'0px',padding:nRotate?'10px':'0px',overflow:nRotate?'':'hidden',visibility:nRotate?'visible':'hidden',marginTop:nRotate?'1rem':'0px'}} >
                  <button className='font-normal cursor-default w-full hover:bg-[#ffffff0c] transition-all duration-300 p-1' onClick={()=>dispatch(setSwitch({key:'news',value:'all'}))} style={{backgroundColor:nCriterion === 'all' || nCriterion === 'gallery' ? '#ffffff4d' : ''}}>همه اخبار</button>
                  <button className='font-normal cursor-default w-full hover:bg-[#ffffff0c] transition-all duration-300 p-1' onClick={()=>dispatch(setSwitch({key:'news',value:'new'}))} style={{backgroundColor:nCriterion === 'new' ? '#ffffff4d' : ''}}>اخبار جدید</button>
                </div>
          </div>
